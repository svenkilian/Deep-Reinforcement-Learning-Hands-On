...
if __name__ == "__main__":
    ...
    parser.add_argument("--reset-close", default=False, action="store_true", help="End episode on close")
    parser.add_argument("--state-1d", default=False, action="store_true", help="Use convolution-ready state representation")
    ...
    if args.year is not None or os.path.isfile(args.data):
        ...
        env = environ.StocksEnv(stock_data, bars_count=BARS_COUNT,
                                reset_on_close=reset_on_close, state_1d=use_state_1d, volumes=False)
        env_tst = environ.StocksEnv(
            stock_data, bars_count=BARS_COUNT, reset_on_close=reset_on_close, state_1d=use_state_1d)
    elif os.path.isdir(args.data):
        env = environ.StocksEnv.from_dir(
            args.data, bars_count=BARS_COUNT, reset_on_close=reset_on_close, state_1d=use_state_1d)
